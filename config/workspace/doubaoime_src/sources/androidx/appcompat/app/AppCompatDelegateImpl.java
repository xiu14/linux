...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private ViewGroup createSubDecor() {
        ...
        if (viewGroup == null) {
            StringBuilder M = e.a.a.a.a.M("AppCompat does not support the current theme features: { windowActionBar: ");
    ...
    */
    ...
    public Context attachBaseContext2(@NonNull Context context) {
        ...
        Configuration createOverrideAppConfiguration = createOverrideAppConfiguration(context, mapNightMode, calculateApplicationLocales, configuration2.equals(configuration3) ? null : generateConfigDelta(configuration2, configuration3), true);
