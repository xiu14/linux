...
class TwilightManager {
    ...
    private void updateState(@NonNull Location location) {
        ...
        twilightCalculator.calculateTwilight(currentTimeMillis - com.heytap.mcssdk.constant.a.f6888f, location.getLatitude(), location.getLongitude());
        ...
        if (j2 == -1 || j3 == -1) {
            j = com.heytap.mcssdk.constant.a.f6889g + currentTimeMillis;
        } else {
            j = (currentTimeMillis > j3 ? j4 + 0 : currentTimeMillis > j2 ? j3 + 0 : j2 + 0) + com.heytap.mcssdk.constant.a.f6886d;
        }
