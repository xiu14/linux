...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ...
            StringBuilder N = e.a.a.a.a.N("Invalid icon resource ", iconResource, " for ");
            N.append(componentName.flattenToShortString());
    ...
    Drawable getDrawableFromResourceUri(Uri uri) throws FileNotFoundException {
        ...
        if (TextUtils.isEmpty(authority)) {
            throw new FileNotFoundException(e.a.a.a.a.o("No authority: ", uri));
        }
        try {
            ...
            if (pathSegments == null) {
                throw new FileNotFoundException(e.a.a.a.a.o("No path: ", uri));
            }
            ...
            if (size == 1) {
                try {
                    ...
                    throw new FileNotFoundException(e.a.a.a.a.o("Single path segment is not a resource ID: ", uri));
                }
            } else {
                if (size != 2) {
                    throw new FileNotFoundException(e.a.a.a.a.o("More than two path segments: ", uri));
                }
            ...
            throw new FileNotFoundException(e.a.a.a.a.o("No resource found for: ", uri));
        } catch (PackageManager.NameNotFoundException unused2) {
            throw new FileNotFoundException(e.a.a.a.a.o("No package found for authority: ", uri));
        }
    }
