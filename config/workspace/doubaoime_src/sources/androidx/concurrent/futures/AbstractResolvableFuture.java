...
public abstract class AbstractResolvableFuture<V> implements a<V> {
    ...
    public final V get(long j, TimeUnit timeUnit) throws InterruptedException, TimeoutException, ExecutionException {
        ...
        StringBuilder Q = e.a.a.a.a.Q("Waited ", j, " ");
        Q.append(timeUnit.toString().toLowerCase(locale));
        String sb = Q.toString();
        if (nanos + 1000 < 0) {
            String s = e.a.a.a.a.s(sb, " (plus ");
            long j2 = -nanos;
            ...
            sb = e.a.a.a.a.s(s, "delay)");
        }
        if (isDone()) {
            throw new TimeoutException(e.a.a.a.a.s(sb, " but future completed as timeout expired"));
        }
        throw new TimeoutException(e.a.a.a.a.t(sb, " for ", abstractResolvableFuture));
    }
    ...
    protected String pendingToString() {
        Object obj = this.value;
        if (obj instanceof SetFuture) {
            return e.a.a.a.a.J(e.a.a.a.a.M("setFuture=["), userObjectToString(((SetFuture) obj).future), "]");
        }
        if (!(this instanceof ScheduledFuture)) {
            return null;
        }
        StringBuilder M = e.a.a.a.a.M("remaining delay=[");
    ...
    public String toString() {
        ...
        if (isCancelled()) {
            ...
            try {
                ...
                StringBuilder M = e.a.a.a.a.M("Exception thrown from implementation: ");
                M.append(e2.getClass());
                sb = M.toString();
            }
            if (sb != null && !sb.isEmpty()) {
                e.a.a.a.a.K0(sb2, "PENDING, info=[", sb, "]");
            } else if (isDone()) {
                addDoneString(sb2);
            } else {
                sb2.append("PENDING");
