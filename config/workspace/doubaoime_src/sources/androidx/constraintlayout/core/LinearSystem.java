...
public class LinearSystem {
    ...
    private void displayRows() {
        ...
        for (int i = 0; i < this.mNumRows; i++) {
            ...
            M.append(this.mRows[i]);
            str = a.s(M.toString(), "\n");
        }
        StringBuilder M2 = a.M(str);
        M2.append(this.mGoal);
        M2.append("\n");
        System.out.println(M2.toString());
    }

    private void displaySolverVariables() {
        StringBuilder M = a.M("Display Rows (");
        M.append(this.mNumRows);
        M.append("x");
        System.out.println(a.D(M, this.mNumColumns, ")\n"));
    }
    ...
    */
    ...
    public void displayReadableRows() {
        ...
        for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
            ...
            if (solverVariable2 != null && solverVariable2.isSynonym) {
                s = s + " ~[" + i2 + "] => " + solverVariable2 + " = " + solverVariableArr[solverVariable2.synonym] + " + " + solverVariable2.synonymDelta + "\n";
            }
        }
        String s2 = a.s(s, "\n\n #  ");
        for (int i3 = 0; i3 < this.mNumRows; i3++) {
            StringBuilder M = a.M(s2);
            M.append(this.mRows[i3].toReadableString());
            s2 = a.s(M.toString(), "\n #  ");
        }
        if (this.mGoal != null) {
            StringBuilder S = a.S(s2, "Goal: ");
            S.append(this.mGoal);
            S.append("\n");
            s2 = S.toString();
        }
    ...
    void displaySystemInformation() {
        ...
        StringBuilder M = a.M("Linear System -> Table size: ");
        M.append(this.TABLE_SIZE);
        M.append(" (");
        int i5 = this.TABLE_SIZE;
        M.append(getDisplaySize(i5 * i5));
        M.append(") -- row sizes: ");
        M.append(getDisplaySize(i));
        M.append(", actual size: ");
        M.append(getDisplaySize(i3));
        M.append(" rows: ");
        M.append(this.mNumRows);
        M.append("/");
        M.append(this.mMaxRows);
        M.append(" cols: ");
        M.append(this.mNumColumns);
        M.append("/");
        a.F0(M, this.mMaxColumns, " ", 0, " occupied cells, ");
        M.append(getDisplaySize(0));
    ...
    public void displayVariablesReadableRows() {
        ...
        for (int i = 0; i < this.mNumRows; i++) {
            if (this.mRows[i].variable.mType == SolverVariable.Type.UNRESTRICTED) {
                StringBuilder M = a.M(str);
                M.append(this.mRows[i].toReadableString());
                str = a.s(M.toString(), "\n");
            }
        }
        StringBuilder M2 = a.M(str);
