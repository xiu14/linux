...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (variable != null) {
                ...
                String s3 = a.s(str2, "[p: ");
                if (this.previous[indexOf] != -1) {
                    StringBuilder M = a.M(s3);
                    M.append(this.mCache.mIndexedVariables[this.variables[this.previous[indexOf]]]);
                    s = M.toString();
                } else {
                    s = a.s(s3, "none");
                }
                ...
                if (this.next[indexOf] != -1) {
                    StringBuilder M2 = a.M(s4);
                    M2.append(this.mCache.mIndexedVariables[this.variables[this.next[indexOf]]]);
                    s2 = M2.toString();
                } else {
                    s2 = a.s(s4, "none");
                }
    ...
    public float use(ArrayRow arrayRow, boolean z) {
        ...
        while (i < currentSize) {
            ...
            if (iArr[i2] != -1) {
                add(this.mCache.mIndexedVariables[iArr[i2]], solverVariableValues.values[i2] * f2, z);
                i++;
            }
            i2++;
        }
