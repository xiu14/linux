...
public class BarrierReference extends HelperReference {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                int[] iArr2 = $SwitchMap$androidx$constraintlayout$core$state$State$Direction;
                State.Direction direction2 = State.Direction.START;
                iArr2[2] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                int[] iArr3 = $SwitchMap$androidx$constraintlayout$core$state$State$Direction;
                State.Direction direction3 = State.Direction.RIGHT;
                iArr3[1] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                int[] iArr4 = $SwitchMap$androidx$constraintlayout$core$state$State$Direction;
                State.Direction direction4 = State.Direction.END;
                iArr4[3] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                int[] iArr5 = $SwitchMap$androidx$constraintlayout$core$state$State$Direction;
                State.Direction direction5 = State.Direction.TOP;
                iArr5[4] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                int[] iArr6 = $SwitchMap$androidx$constraintlayout$core$state$State$Direction;
