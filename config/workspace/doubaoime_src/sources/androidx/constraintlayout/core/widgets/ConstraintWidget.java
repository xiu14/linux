...
public class ConstraintWidget {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                int[] iArr2 = $SwitchMap$androidx$constraintlayout$core$widgets$ConstraintWidget$DimensionBehaviour;
                DimensionBehaviour dimensionBehaviour2 = DimensionBehaviour.WRAP_CONTENT;
                iArr2[1] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                int[] iArr3 = $SwitchMap$androidx$constraintlayout$core$widgets$ConstraintWidget$DimensionBehaviour;
                DimensionBehaviour dimensionBehaviour3 = DimensionBehaviour.MATCH_PARENT;
                iArr3[3] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                int[] iArr4 = $SwitchMap$androidx$constraintlayout$core$widgets$ConstraintWidget$DimensionBehaviour;
            ...
            int[] iArr5 = new int[9];
            $SwitchMap$androidx$constraintlayout$core$widgets$ConstraintAnchor$Type = iArr5;
            try {
            ...
            try {
                int[] iArr10 = $SwitchMap$androidx$constraintlayout$core$widgets$ConstraintAnchor$Type;
                ConstraintAnchor.Type type6 = ConstraintAnchor.Type.CENTER;
                iArr10[6] = 6;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                int[] iArr11 = $SwitchMap$androidx$constraintlayout$core$widgets$ConstraintAnchor$Type;
                ConstraintAnchor.Type type7 = ConstraintAnchor.Type.CENTER_X;
                iArr11[7] = 7;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                int[] iArr12 = $SwitchMap$androidx$constraintlayout$core$widgets$ConstraintAnchor$Type;
                ConstraintAnchor.Type type8 = ConstraintAnchor.Type.CENTER_Y;
                iArr12[8] = 8;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                int[] iArr13 = $SwitchMap$androidx$constraintlayout$core$widgets$ConstraintAnchor$Type;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:180:0x0474, code lost:
        ...
        if ((r1 instanceof androidx.constraintlayout.core.widgets.Barrier) != false) goto L268;
     */
    ...
    /* JADX WARN: Removed duplicated region for block: B:321:0x00f5  */
    /* JADX WARN: Removed duplicated region for block: B:32:0x00a2  */
    /* JADX WARN: Removed duplicated region for block: B:379:0x00c3  */
    /* JADX WARN: Removed duplicated region for block: B:380:0x009e  */
    /* JADX WARN: Removed duplicated region for block: B:38:0x00c8  */
    /* JADX WARN: Removed duplicated region for block: B:48:0x01fd  */
    /* JADX WARN: Removed duplicated region for block: B:52:0x0573 A[ADDED_TO_REGION] */
    ...
    */
    ...
    private void serializeSize(StringBuilder sb, String str, int i, int i2, int i3, int i4, int i5, int i6, float f2, float f3) {
        sb.append(str);
        sb.append(" :  {\n");
        serializeAttribute(sb, MonitorConstants.SIZE, i, Integer.MIN_VALUE);
    ...
    */
    ...
    public String toString() {
        ...
        sb.append(this.mType != null ? a.J(a.M("type: "), this.mType, " ") : "");
        sb.append(this.mDebugName != null ? a.J(a.M("id: "), this.mDebugName, " ") : "");
        sb.append("(");
        sb.append(this.mX);
        sb.append(", ");
        sb.append(this.mY);
