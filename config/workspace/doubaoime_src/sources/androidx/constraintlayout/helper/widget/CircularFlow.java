...
public class CircularFlow extends VirtualLayout {
            ...
            if (viewById != null) {
                ...
                if (iArr == null || i >= iArr.length) {
                    ...
                    if (num == null || num.intValue() == -1) {
                        StringBuilder M = e.a.a.a.a.M("Added radius to view with id: ");
                        M.append(this.mMap.get(Integer.valueOf(viewById.getId())));
                ...
                if (fArr == null || i >= fArr.length) {
                    ...
                    if (f3 == null || f3.floatValue() == -1.0f) {
                        StringBuilder M2 = e.a.a.a.a.M("Added angle to view with id: ");
                        M2.append(this.mMap.get(Integer.valueOf(viewById.getId())));
    ...
    public void updateAngle(View view, float f2) {
        if (!isUpdatable(view)) {
            StringBuilder M = e.a.a.a.a.M("It was not possible to update angle to view with id: ");
            M.append(view.getId());
            Log.e(TAG, M.toString());
            return;
        }
    ...
    public void updateRadius(View view, int i) {
        if (!isUpdatable(view)) {
            StringBuilder M = e.a.a.a.a.M("It was not possible to update radius to view with id: ");
            M.append(view.getId());
            Log.e(TAG, M.toString());
            return;
        }
    ...
    public void updateReference(View view, int i, float f2) {
        if (!isUpdatable(view)) {
            StringBuilder M = e.a.a.a.a.M("It was not possible to update radius and angle to view with id: ");
            M.append(view.getId());
            Log.e(TAG, M.toString());
            return;
        }
