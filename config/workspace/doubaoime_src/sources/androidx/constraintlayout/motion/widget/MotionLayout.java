...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    static /* synthetic */ class AnonymousClass5 {
        ...
        static {
            ...
            try {
                int[] iArr2 = $SwitchMap$androidx$constraintlayout$motion$widget$MotionLayout$TransitionState;
                TransitionState transitionState2 = TransitionState.SETUP;
                iArr2[1] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                int[] iArr3 = $SwitchMap$androidx$constraintlayout$motion$widget$MotionLayout$TransitionState;
                TransitionState transitionState3 = TransitionState.MOVING;
                iArr3[2] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                int[] iArr4 = $SwitchMap$androidx$constraintlayout$motion$widget$MotionLayout$TransitionState;
    ...
    private class DevModeDraw {
        ...
        private void drawPathCartesianTicks(Canvas canvas, float f2, float f3) {
            ...
            M.append(((int) (((min2 * 100.0f) / Math.abs(f6 - f4)) + 0.5d)) / 100.0f);
            ...
            M2.append(((int) (((max2 * 100.0f) / Math.abs(f7 - f5)) + 0.5d)) / 100.0f);
        ...
        private void drawPathScreenTicks(Canvas canvas, float f2, float f3, int i, int i2) {
            StringBuilder M = e.a.a.a.a.M("");
            M.append(((int) ((((f2 - (i / 2)) * 100.0f) / (MotionLayout.this.getWidth() - i)) + 0.5d)) / 100.0f);
            String sb = M.toString();
            getTextBounds(sb, this.mTextPaint);
            ...
            StringBuilder M2 = e.a.a.a.a.M("");
            M2.append(((int) ((((f3 - (i2 / 2)) * 100.0f) / (MotionLayout.this.getHeight() - i2)) + 0.5d)) / 100.0f);
            String sb2 = M2.toString();
            getTextBounds(sb2, this.mTextPaint);
                ...
                if (i != 4 || this.mPathMode[i5 - 1] != 0) {
                    ...
                    if (i == 4) {
                        ...
                        if (iArr[i7] == 1) {
                            ...
                            f2 = f5;
                            f3 = f4;
                            drawPathScreenTicks(canvas, f4 - 0.0f, f5 - 0.0f, i3, i4);
                    ...
                    if (i == 6) {
                        drawPathScreenTicks(canvas, f3 - 0.0f, f2 - 0.0f, i3, i4);
                    }
                    canvas.drawPath(this.mPath, this.mFillPaint);
                }
            }
    ...
    class Model {
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String str3 = BundleUtil.UNDERLINE_TAG;
                M.append(constraintAnchor != null ? ExifInterface.GPS_DIRECTION_TRUE : BundleUtil.UNDERLINE_TAG);
                StringBuilder M2 = e.a.a.a.a.M(M.toString());
                M2.append(constraintWidget.mBottom.mTarget != null ? "B" : BundleUtil.UNDERLINE_TAG);
                StringBuilder M3 = e.a.a.a.a.M(M2.toString());
                M3.append(constraintWidget.mLeft.mTarget != null ? "L" : BundleUtil.UNDERLINE_TAG);
                StringBuilder M4 = e.a.a.a.a.M(M3.toString());
                ...
                if (view2 instanceof TextView) {
                    StringBuilder S2 = e.a.a.a.a.S(name, "(");
                    S2.append((Object) ((TextView) view2).getText());
                    S2.append(")");
                    name = S2.toString();
                }
        ...
        private void debugLayoutParam(String str, ConstraintLayout.LayoutParams layoutParams) {
            StringBuilder M = e.a.a.a.a.M(" ");
            M.append(layoutParams.startToStart != -1 ? "SS" : "__");
            StringBuilder M2 = e.a.a.a.a.M(M.toString());
            M2.append(layoutParams.startToEnd != -1 ? "|SE" : "|__");
            StringBuilder M3 = e.a.a.a.a.M(M2.toString());
            M3.append(layoutParams.endToStart != -1 ? "|ES" : "|__");
            StringBuilder M4 = e.a.a.a.a.M(M3.toString());
            M4.append(layoutParams.endToEnd != -1 ? "|EE" : "|__");
            StringBuilder M5 = e.a.a.a.a.M(M4.toString());
            M5.append(layoutParams.leftToLeft != -1 ? "|LL" : "|__");
            StringBuilder M6 = e.a.a.a.a.M(M5.toString());
            M6.append(layoutParams.leftToRight != -1 ? "|LR" : "|__");
            StringBuilder M7 = e.a.a.a.a.M(M6.toString());
            M7.append(layoutParams.rightToLeft != -1 ? "|RL" : "|__");
            StringBuilder M8 = e.a.a.a.a.M(M7.toString());
            M8.append(layoutParams.rightToRight != -1 ? "|RR" : "|__");
            StringBuilder M9 = e.a.a.a.a.M(M8.toString());
            M9.append(layoutParams.topToTop != -1 ? "|TT" : "|__");
            StringBuilder M10 = e.a.a.a.a.M(M9.toString());
            M10.append(layoutParams.topToBottom != -1 ? "|TB" : "|__");
            StringBuilder M11 = e.a.a.a.a.M(M10.toString());
            M11.append(layoutParams.bottomToTop != -1 ? "|BT" : "|__");
            StringBuilder M12 = e.a.a.a.a.M(M11.toString());
            M12.append(layoutParams.bottomToBottom != -1 ? "|BB" : "|__");
            Log.v(MotionLayout.TAG, str + M12.toString());
        }
        ...
        private void debugWidget(String str, ConstraintWidget constraintWidget) {
            ...
            if (constraintWidget.mTop.mTarget != null) {
                StringBuilder M2 = e.a.a.a.a.M(ExifInterface.GPS_DIRECTION_TRUE);
                M2.append(constraintWidget.mTop.mTarget.mType == ConstraintAnchor.Type.TOP ? ExifInterface.GPS_DIRECTION_TRUE : "B");
                str2 = M2.toString();
            } else {
                str2 = "__";
            }
            M.append(str2);
            StringBuilder M3 = e.a.a.a.a.M(M.toString());
            if (constraintWidget.mBottom.mTarget != null) {
                StringBuilder M4 = e.a.a.a.a.M("B");
                M4.append(constraintWidget.mBottom.mTarget.mType == ConstraintAnchor.Type.TOP ? ExifInterface.GPS_DIRECTION_TRUE : "B");
                str3 = M4.toString();
            } else {
                str3 = "__";
            }
            M3.append(str3);
            StringBuilder M5 = e.a.a.a.a.M(M3.toString());
            if (constraintWidget.mLeft.mTarget != null) {
                StringBuilder M6 = e.a.a.a.a.M("L");
                M6.append(constraintWidget.mLeft.mTarget.mType == ConstraintAnchor.Type.LEFT ? "L" : "R");
                str4 = M6.toString();
            } else {
                str4 = "__";
            }
            M5.append(str4);
            StringBuilder M7 = e.a.a.a.a.M(M5.toString());
            if (constraintWidget.mRight.mTarget != null) {
                StringBuilder M8 = e.a.a.a.a.M("R");
                M8.append(constraintWidget.mRight.mTarget.mType == ConstraintAnchor.Type.LEFT ? "L" : "R");
                str5 = M8.toString();
            }
            M7.append(str5);
            Log.v(MotionLayout.TAG, str + M7.toString() + " ---  " + constraintWidget);
        }
    ...
    private void debugPos() {
        for (int i = 0; i < getChildCount(); i++) {
            View childAt = getChildAt(i);
            StringBuilder M = e.a.a.a.a.M(" ");
            M.append(Debug.getLocation());
            M.append(" ");
            M.append(Debug.getName(this));
            M.append(" ");
            M.append(Debug.getName(getContext(), this.mCurrentState));
            M.append(" ");
            M.append(Debug.getName(childAt));
            M.append(childAt.getLeft());
            M.append(" ");
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if ((this.mDebugPath & 1) == 1 && !isInEditMode()) {
            ...
            StringBuilder M = e.a.a.a.a.M(this.mLastFps + " fps " + Debug.getState(this, this.mBeginState) + " -> ");
            M.append(Debug.getState(this, this.mEndState));
            M.append(" (progress: ");
            M.append(((int) (getProgress() * 1000.0f)) / 10.0f);
            M.append(" ) state=");
            int i = this.mCurrentState;
            M.append(i == -1 ? "undefined" : Debug.getState(this, i));
            String sb = M.toString();
    ...
    */
    ...
    public void fireTrigger(int i, boolean z, float f2) {
        ...
        if (copyOnWriteArrayList != null) {
            Iterator<TransitionListener> it2 = copyOnWriteArrayList.iterator();
            while (it2.hasNext()) {
                it2.next().onTransitionTrigger(this, i, z, f2);
            }
        }
    }

    void getAnchorDpDt(int i, float f2, float f3, float f4, float[] fArr) {
        ...
        Log.w(TAG, "WARNING could not find view id " + (viewById == null ? e.a.a.a.a.j("", i) : viewById.getContext().getResources().getResourceName(i)));
    }
    ...
    */
    ...
    private static class MyTracker implements MotionTracker {
        ...
        private static MyTracker f1214me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f1214me.tracker = VelocityTracker.obtain();
            return f1214me;
        }
    ...
    private void checkStructure(int i, ConstraintSet constraintSet) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (id == -1) {
                StringBuilder U = e.a.a.a.a.U("CHECK: ", name, " ALL VIEWS SHOULD HAVE ID's ");
                U.append(childAt.getClass().getName());
                U.append(" does not!");
                Log.w(TAG, U.toString());
            }
            if (constraintSet.getConstraint(id) == null) {
                StringBuilder U2 = e.a.a.a.a.U("CHECK: ", name, " NO CONSTRAINTS for ");
        ...
        for (int i3 = 0; i3 < knownIds.length; i3++) {
            ...
            if (constraintSet.getHeight(i4) == -1) {
                Log.w(TAG, e.a.a.a.a.v("CHECK: ", name, "(", name2, ") no LAYOUT_HEIGHT"));
            }
