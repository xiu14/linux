...
public class MotionScene {
    ...
    private void readConstraintChain(int i, MotionLayout motionLayout) {
        ...
        if (i2 > 0) {
            ...
            if (constraintSet2 == null) {
                StringBuilder M = e.a.a.a.a.M("ERROR! invalid deriveConstraintsFrom: @id/");
                M.append(Debug.getName(this.mMotionLayout.getContext(), i2));
                Log.e(TypedValues.MotionScene.NAME, M.toString());
                return;
            } else {
            ...
            constraintSet.derivedState = e.a.a.a.a.J(new StringBuilder(), constraintSet.derivedState, "  layout");
                ...
                if (touchRegion == null || motionEvent == null || touchRegion.contains(motionEvent.getX(), motionEvent.getY())) {
                    ...
                    if (limitBoundsTo == null || motionEvent == null || limitBoundsTo.contains(motionEvent.getX(), motionEvent.getY())) {
                        ...
                        if (transition2.mTouchResponse.mIsRotateMode && motionEvent != null) {
                            dot = ((float) (Math.atan2(f3 + r10, f2 + r9) - Math.atan2(motionEvent.getX() - transition2.mTouchResponse.mRotateCenterX, motionEvent.getY() - transition2.mTouchResponse.mRotateCenterY))) * 10.0f;
                        }
                        float f5 = dot * (transition2.mConstraintSetEnd == i ? -1.0f : 1.1f);
                        if (f5 > f4) {
                            transition = transition2;
                            f4 = f5;
                        }
    ...
    public ConstraintSet getConstraintSet(Context context, String str) {
        if (this.DEBUG_DESKTOP) {
            ...
            M.append(this.mConstraintSetMap.size());
        ...
        for (int i = 0; i < this.mConstraintSetMap.size(); i++) {
            ...
            if (this.DEBUG_DESKTOP) {
                ...
                StringBuilder P = e.a.a.a.a.P("Id for <", i, "> is <", resourceName, "> looking for <");
                P.append(str);
                P.append(">");
    ...
    */
    ...
    public static class Transition {
        ...
        public String debugString(Context context) {
            ...
            if (this.mConstraintSetEnd == -1) {
                return e.a.a.a.a.s(resourceEntryName, " -> null");
            }
            StringBuilder S = e.a.a.a.a.S(resourceEntryName, " -> ");
        ...
        public static class TransitionOnClick implements View.OnClickListener {
            ...
            public void addOnClickListeners(MotionLayout motionLayout, int i, Transition transition) {
                ...
                if (motionLayout2 == null) {
                    StringBuilder M = e.a.a.a.a.M("OnClick could not find id ");
            ...
            */
            ...
            public void removeOnClickListeners(MotionLayout motionLayout) {
                ...
                StringBuilder M = e.a.a.a.a.M(" (*)  could not find id ");
                M.append(this.mTargetId);
                Log.e(TypedValues.MotionScene.NAME, M.toString());
            }
    ...
    ConstraintSet getConstraintSet(int i, int i2, int i3) {
        ...
        if (this.mConstraintSetMap.get(i) == null) {
            StringBuilder M2 = e.a.a.a.a.M("Warning could not find ConstraintSet id/");
            M2.append(Debug.getName(this.mMotionLayout.getContext(), i));
            M2.append(" In MotionScene");
            Log.e(TypedValues.MotionScene.NAME, M2.toString());
