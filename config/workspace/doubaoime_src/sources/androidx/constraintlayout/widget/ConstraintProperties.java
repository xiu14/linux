...
public class ConstraintProperties {
    ...
    public ConstraintProperties center(int i, int i2, int i3, int i4, int i5, int i6, float f2) {
        if (i3 < 0) {
    ...
    public ConstraintProperties centerHorizontally(int i, int i2, int i3, int i4, int i5, int i6, float f2) {
        connect(1, i, i2, i3);
        connect(2, i4, i5, i6);
        this.mParams.horizontalBias = f2;
        return this;
    ...
    public ConstraintProperties centerHorizontallyRtl(int i, int i2, int i3, int i4, int i5, int i6, float f2) {
        connect(6, i, i2, i3);
        connect(7, i4, i5, i6);
        this.mParams.horizontalBias = f2;
        return this;
    ...
    public ConstraintProperties centerVertically(int i, int i2, int i3, int i4, int i5, int i6, float f2) {
        connect(3, i, i2, i3);
        connect(4, i4, i5, i6);
        this.mParams.verticalBias = f2;
        return this;
        ...
        switch (i) {
            case 1:
                if (i3 == 1) {
                    ...
                    if (i3 != 2) {
                        throw new IllegalArgumentException(a.J(a.M("Left to "), sideToString(i3), " undefined"));
                    }
            ...
            case 2:
                if (i3 == 1) {
                    ...
                    if (i3 != 2) {
                        throw new IllegalArgumentException(a.J(a.M("right to "), sideToString(i3), " undefined"));
                    }
