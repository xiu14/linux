...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    private void offsetChildByInset(View view, Rect rect, int i) {
        ...
        if (ViewCompat.isLaidOut(view) && view.getWidth() > 0 && view.getHeight() > 0) {
            ...
            if (behavior == null || !behavior.getInsetDodgeRect(this, view, acquireTempRect)) {
                ...
                StringBuilder M = a.M("Rect should be within the child's bounds. Rect:");
                M.append(acquireTempRect.toShortString());
                M.append(" | Bounds:");
                M.append(acquireTempRect2.toShortString());
    ...
    static Behavior parseBehavior(Context context, AttributeSet attributeSet, String str) {
        ...
        if (str.startsWith(".")) {
            str = a.c(context, new StringBuilder(), str);
        ...
        try {
            ...
            throw new RuntimeException(a.s("Could not inflate Behavior subclass ", str), e2);
        }
    }
    ...
    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i) {
        ...
        if (resourceId != 0) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                this.mKeylines[i2] = (int) (r12[i2] * f2);
            }
        }
        ...
        private void resolveAnchorView(View view, CoordinatorLayout coordinatorLayout) {
            ...
            if (findViewById == null) {
                if (coordinatorLayout.isInEditMode()) {
                    ...
                    StringBuilder M = a.M("Could not find CoordinatorLayout descendant view with id ");
                    M.append(coordinatorLayout.getResources().getResourceName(this.mAnchorId));
