        ...
        public void onSharedElementsArrived(List<String> list, List<View> list2, final SharedElementCallback.OnSharedElementsReadyListener onSharedElementsReadyListener) {
            this.mCallback.onSharedElementsArrived(list, list2, new SharedElementCallback.OnSharedElementsReadyListener() { // from class: androidx.core.app.a
                ...
                public final void onSharedElementsReady() {
                    SharedElementCallback.OnSharedElementsReadyListener onSharedElementsReadyListener2 = onSharedElementsReadyListener;
                    int i = ActivityCompat.SharedElementCallback21Impl.a;
                    ActivityCompat.Api23Impl.onSharedElementsReady(onSharedElementsReadyListener2);
                }
            });
        }
    }
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            new Handler(activity.getMainLooper()).post(new Runnable() { // from class: androidx.core.app.b
                ...
                public final void run() {
                    ...
                    if (activity2.isFinishing() || ActivityRecreator.recreate(activity2)) {
                        return;
                    }
                    activity2.recreate();
                }
        ...
        if (permissionCompatDelegate == null || !permissionCompatDelegate.requestPermissions(activity, strArr, i)) {
            ...
            for (int i2 = 0; i2 < strArr.length; i2++) {
                if (TextUtils.isEmpty(strArr[i2])) {
                    throw new IllegalArgumentException(e.a.a.a.a.J(e.a.a.a.a.M("Permission request for permissions "), Arrays.toString(strArr), " must not contain null or empty values"));
                }
