...
public final class NotificationManagerCompat {
    ...
    private static class NotifyTask implements Task {
        ...
        public String toString() {
            StringBuilder R = e.a.a.a.a.R("NotifyTask[", "packageName:");
            R.append(this.packageName);
            R.append(", id:");
            R.append(this.id);
            R.append(", tag:");
            return e.a.a.a.a.J(R, this.tag, "]");
        }
    }
    ...
    private static class SideChannelManager implements Handler.Callback, ServiceConnection {
        ...
        private boolean ensureServiceBound(ListenerRecord listenerRecord) {
            ...
            if (bindService) {
                ...
                StringBuilder M = e.a.a.a.a.M("Unable to bind to listener ");
                M.append(listenerRecord.componentName);
                Log.w(NotificationManagerCompat.TAG, M.toString());
        ...
        private void handleServiceConnected(ComponentName componentName, IBinder iBinder) {
            ListenerRecord listenerRecord = this.mRecordMap.get(componentName);
            if (listenerRecord != null) {
                listenerRecord.service = a.AbstractBinderC0000a.asInterface(iBinder);
                listenerRecord.retryCount = 0;
                processListenerQueue(listenerRecord);
            }
        }
        ...
        private void processListenerQueue(ListenerRecord listenerRecord) {
            if (Log.isLoggable(NotificationManagerCompat.TAG, 3)) {
                StringBuilder M = e.a.a.a.a.M("Processing component ");
                M.append(listenerRecord.componentName);
                M.append(", ");
                M.append(listenerRecord.taskQueue.size());
                M.append(" queued tasks");
                Log.d(NotificationManagerCompat.TAG, M.toString());
            }
            ...
            while (true) {
                ...
                try {
                    ...
                    if (Log.isLoggable(NotificationManagerCompat.TAG, 3)) {
                        StringBuilder M2 = e.a.a.a.a.M("Remote service has died: ");
                        M2.append(listenerRecord.componentName);
                        Log.d(NotificationManagerCompat.TAG, M2.toString());
                    }
                } catch (RemoteException e2) {
                    StringBuilder M3 = e.a.a.a.a.M("RemoteException communicating with ");
                    M3.append(listenerRecord.componentName);
                    Log.w(NotificationManagerCompat.TAG, M3.toString(), e2);
                }
            }
            if (listenerRecord.taskQueue.isEmpty()) {
                return;
        ...
        private void scheduleListenerRetry(ListenerRecord listenerRecord) {
            ...
            if (i > 6) {
                StringBuilder M = e.a.a.a.a.M("Giving up on delivering ");
                M.append(listenerRecord.taskQueue.size());
                M.append(" tasks to ");
                M.append(listenerRecord.componentName);
                M.append(" after ");
        ...
        private void updateListenerMap() {
            ...
            while (it3.hasNext()) {
                ...
                if (!hashSet.contains(next.getKey())) {
                    if (Log.isLoggable(NotificationManagerCompat.TAG, 3)) {
                        StringBuilder M = e.a.a.a.a.M("Removing listener record for ");
    ...
    private static class CancelTask implements Task {
        ...
        @NonNull
        public String toString() {
            StringBuilder R = e.a.a.a.a.R("CancelTask[", "packageName:");
            R.append(this.packageName);
            R.append(", id:");
            R.append(this.id);
            R.append(", tag:");
