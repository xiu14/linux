...
public final class ShareCompat {
    ...
    public static class IntentReader {
        ...
        public Uri getStream(int i) {
            ...
            StringBuilder M = e.a.a.a.a.M("Stream items available: ");
            M.append(getStreamCount());
            M.append(" index requested: ");
            M.append(i);
    ...
    public static void configureMenuItem(@NonNull MenuItem menuItem, @NonNull IntentBuilder intentBuilder) {
        ...
        StringBuilder M = e.a.a.a.a.M(HISTORY_FILENAME_PREFIX);
        M.append(intentBuilder.getContext().getClass().getName());
        shareActionProvider.setShareHistoryFileName(M.toString());
    ...
    public static void configureMenuItem(@NonNull Menu menu, @IdRes int i, @NonNull IntentBuilder intentBuilder) {
        ...
        throw new IllegalArgumentException(e.a.a.a.a.k("Could not find menu item with id ", i, " in the supplied menu"));
    }
}
