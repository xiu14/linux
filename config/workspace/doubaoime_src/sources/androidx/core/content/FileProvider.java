...
public class FileProvider extends ContentProvider {
    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        public File getFileForUri(Uri uri) {
            ...
            if (file == null) {
                throw new IllegalArgumentException(e.a.a.a.a.o("Unable to find configured root for ", uri));
            }
        ...
        public Uri getUriForFile(File file) {
            try {
                ...
                if (entry == null) {
                    throw new IllegalArgumentException(e.a.a.a.a.s("Failed to find configured root that contains ", canonicalPath));
                }
    ...
    static XmlResourceParser getFileProviderPathsMetaData(Context context, String str, @Nullable ProviderInfo providerInfo, int i) {
        if (providerInfo == null) {
            throw new IllegalArgumentException(e.a.a.a.a.s("Couldn't find meta-data for provider with authority ", str));
        }
    ...
    private static int modeToMode(String str) {
        ...
        if (DownloadFileUtils.MODE_WRITE.equals(str) || "wt".equals(str)) {
            return 738197504;
        }
        if ("wa".equals(str)) {
            return 704643072;
        ...
        throw new IllegalArgumentException(e.a.a.a.a.s("Invalid mode: ", str));
    }
