...
public class IntentSanitizer {
        ...
        */
        static void sanitizeClipData(@androidx.annotation.NonNull android.content.Intent r7, android.content.Intent r8, androidx.core.util.Predicate<android.content.ClipData> r9, boolean r10, androidx.core.util.Predicate<android.net.Uri> r11, androidx.core.util.Consumer<java.lang.String> r12) {
            ...
            L35:
                ...
                java.lang.StringBuilder r3 = e.a.a.a.a.N(r3, r9, r4)
            ...
            L52:
                ...
                if (r6 == 0) goto L94
                java.lang.StringBuilder r4 = e.a.a.a.a.N(r5, r9, r4)
    ...
    public static final class Builder {
        ...
        private boolean mAllowSourceBounds;
        private int mAllowedFlags;
        private Predicate<String> mAllowedActions = new Predicate() { // from class: androidx.core.content.e
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return false;
            }
        };
        private Predicate<Uri> mAllowedData = new Predicate() { // from class: androidx.core.content.i
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return false;
            }
        };
        private Predicate<String> mAllowedTypes = new Predicate() { // from class: androidx.core.content.a
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return false;
            }
        ...
        private Predicate<String> mAllowedPackages = new Predicate() { // from class: androidx.core.content.h
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return false;
            }
        ...
        private Predicate<Uri> mAllowedClipDataUri = new Predicate() { // from class: androidx.core.content.b
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return false;
            }
        };
        private Predicate<ClipData> mAllowedClipData = new Predicate() { // from class: androidx.core.content.q
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return false;
            }
        ...
        public Builder allowAnyComponent() {
            ...
            this.mAllowedComponents = new Predicate() { // from class: androidx.core.content.d
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    return true;
                }
        ...
        public <T> Builder allowExtra(@NonNull String str, @NonNull final Class<T> cls, @NonNull final Predicate<T> predicate) {
            ...
            return allowExtra(str, new Predicate() { // from class: androidx.core.content.p
                ...
                public final boolean test(Object obj) {
                    Class cls2 = cls;
                    return cls2.isInstance(obj) && predicate.test(cls2.cast(obj));
                }
            });
        }
        ...
        public Builder allowExtra(@NonNull String str, @NonNull Predicate<Object> predicate) {
            ...
            if (predicate2 == null) {
                predicate2 = new Predicate() { // from class: androidx.core.content.f
                    @Override // androidx.core.util.Predicate
                    public final boolean test(Object obj) {
                        return false;
                    }
    ...
    private void putExtra(Intent intent, String str, Object obj) {
        ...
        if (obj instanceof Parcelable[]) {
            ...
            StringBuilder M = e.a.a.a.a.M("Unsupported type ");
    ...
    public Intent sanitize(@NonNull Intent intent, @NonNull Consumer<String> consumer) {
        ...
        if (i2 >= 29) {
            if (this.mAllowIdentifier) {
                ...
                StringBuilder M = e.a.a.a.a.M("Identifier is not allowed: ");
                M.append(Api29Impl.getIdentifier(intent));
                consumer.accept(M.toString());
            }
        }
        if (this.mAllowSelector) {
            ...
            StringBuilder M2 = e.a.a.a.a.M("Selector is not allowed: ");
            M2.append(Api15Impl.getSelector(intent));
            consumer.accept(M2.toString());
        }
        if (this.mAllowSourceBounds) {
            intent2.setSourceBounds(intent.getSourceBounds());
        } else if (intent.getSourceBounds() != null) {
            StringBuilder M3 = e.a.a.a.a.M("SourceBounds is not allowed: ");
            M3.append(intent.getSourceBounds());
            consumer.accept(M3.toString());
        }
        return intent2;
    }
    ...
    public Intent sanitizeByFiltering(@NonNull Intent intent) {
        return sanitize(intent, new Consumer() { // from class: androidx.core.content.s
    ...
    public Intent sanitizeByThrowing(@NonNull Intent intent) {
        return sanitize(intent, new Consumer() { // from class: androidx.core.content.r
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
