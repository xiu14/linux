...
public class ShortcutInfoCompat {
            ...
            if (this.mCapabilityBindingParams != null) {
                ...
                for (String str : this.mCapabilityBindingParams.keySet()) {
                    ...
                    for (String str2 : map.keySet()) {
                        ...
                        this.mInfo.mExtras.putStringArray(a.t(str, "/", str2), list == null ? new String[0] : (String[]) list.toArray(new String[0]));
                    }
                }
            }
    ...
    private PersistableBundle buildLegacyExtrasBundle() {
        ...
        if (personArr != null && personArr.length > 0) {
            ...
            while (i < this.mPersons.length) {
                ...
                StringBuilder M = a.M(EXTRA_PERSON_);
                int i2 = i + 1;
                M.append(i2);
                persistableBundle.putPersistableBundle(M.toString(), this.mPersons[i].toPersistableBundle());
                i = i2;
            }
        }
    ...
    static Person[] getPersonsFromExtra(@NonNull PersistableBundle persistableBundle) {
        ...
        while (i2 < i) {
            ...
            int i3 = i2 + 1;
            M.append(i3);
            personArr[i2] = Person.fromPersistableBundle(persistableBundle.getPersistableBundle(M.toString()));
            i2 = i3;
        }
        return personArr;
    }
