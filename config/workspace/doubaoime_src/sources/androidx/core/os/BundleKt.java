        ...
        for (g<String, ? extends Object> gVar : gVarArr) {
            ...
            if (b == null) {
                ...
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    l.d(b, "null cannot be cast to non-null type kotlin.Array<android.os.Parcelable>");
                    bundle.putParcelableArray(a, (Parcelable[]) b);
                } else if (String.class.isAssignableFrom(componentType)) {
                    l.d(b, "null cannot be cast to non-null type kotlin.Array<kotlin.String>");
                    bundle.putStringArray(a, (String[]) b);
                } else if (CharSequence.class.isAssignableFrom(componentType)) {
                    l.d(b, "null cannot be cast to non-null type kotlin.Array<kotlin.CharSequence>");
