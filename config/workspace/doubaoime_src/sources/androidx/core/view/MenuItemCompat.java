...
public final class MenuItemCompat {
    ...
    public static void setAlphabeticShortcut(@NonNull MenuItem menuItem, char c2, int i) {
        if (menuItem instanceof SupportMenuItem) {
    ...
    public static void setNumericShortcut(@NonNull MenuItem menuItem, char c2, int i) {
        if (menuItem instanceof SupportMenuItem) {
    ...
    public static void setShortcut(@NonNull MenuItem menuItem, char c2, char c3, int i, int i2) {
        if (menuItem instanceof SupportMenuItem) {
