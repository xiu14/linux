...
public class WindowInsetsCompat {
    ...
    static class Api21ReflectionHolder {
        ...
        static {
            try {
                ...
                StringBuilder M = e.a.a.a.a.M("Failed to get visible insets from AttachInfo ");
                M.append(e2.getMessage());
                Log.w(WindowInsetsCompat.TAG, M.toString(), e2);
            }
        }
        ...
        public static WindowInsetsCompat getRootWindowInsets(@NonNull View view) {
            if (sReflectionSucceeded && view.isAttachedToWindow()) {
                try {
                    ...
                    StringBuilder M = e.a.a.a.a.M("Failed to get insets from AttachInfo. ");
                    M.append(e2.getMessage());
                    Log.w(WindowInsetsCompat.TAG, M.toString(), e2);
                }
            }
        ...
        private Insets getVisibleInsets(@NonNull View view) {
            ...
            if (method != null && sAttachInfoClass != null && sVisibleInsetsField != null) {
                try {
                    ...
                    StringBuilder M = e.a.a.a.a.M("Failed to get visible insets. (Reflection error). ");
                    M.append(e2.getMessage());
                    Log.e(WindowInsetsCompat.TAG, M.toString(), e2);
                }
            }
            return null;
        }
    ...
    public static final class Type {
        ...
        static int indexOf(int i) {
            ...
            throw new IllegalArgumentException(e.a.a.a.a.j("type needs to be >= FIRST and <= LAST, type=", i));
        }
