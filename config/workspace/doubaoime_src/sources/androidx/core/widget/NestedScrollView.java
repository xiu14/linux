...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            StringBuilder M = e.a.a.a.a.M("HorizontalScrollView.SavedState{");
            M.append(Integer.toHexString(System.identityHashCode(this)));
            M.append(" scrollPosition=");
            return e.a.a.a.a.D(M, this.scrollPosition, "}");
        }
    ...
    private float getSplineFlingDistance(int i) {
        ...
        return (float) (Math.exp((f2 / (f2 - 1.0d)) * log) * this.mPhysicalCoeff * SCROLL_FRICTION);
    }
    ...
    */
    ...
    int consumeFlingInVerticalStretch(int i) {
        ...
        float f2 = height;
        int round2 = Math.round(EdgeEffectCompat.onPullDistance(this.mEdgeGlowBottom, (i * FLING_DESTRETCH_FACTOR) / f2, 0.5f) * (f2 / FLING_DESTRETCH_FACTOR));
        if (round2 != i) {
