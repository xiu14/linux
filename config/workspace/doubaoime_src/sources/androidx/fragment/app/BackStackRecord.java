...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
        ...
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (fragment != null) {
                    ...
                    if (FragmentManager.isLoggingEnabled(2)) {
                        StringBuilder M = a.M("Bump nesting of ");
    ...
    void executeOps() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (op.mCmd) {
                ...
                case 2:
                default:
                    StringBuilder M = a.M("Unknown cmd: ");
                    M.append(op.mCmd);
    ...
    public FragmentTransaction hide(@NonNull Fragment fragment) {
        ...
        StringBuilder M = a.M("Cannot hide Fragment attached to a different FragmentManager. Fragment ");
        M.append(fragment.toString());
        M.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(M.toString());
    }
    ...
    public FragmentTransaction remove(@NonNull Fragment fragment) {
        ...
        StringBuilder M = a.M("Cannot remove Fragment attached to a different FragmentManager. Fragment ");
        M.append(fragment.toString());
        M.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(M.toString());
    }
    ...
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull Lifecycle.State state) {
        if (fragment.mFragmentManager != this.mManager) {
            StringBuilder M = a.M("Cannot setMaxLifecycle for Fragment not attached to FragmentManager ");
            M.append(this.mManager);
            throw new IllegalArgumentException(M.toString());
        }
    ...
    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        ...
        StringBuilder M = a.M("Cannot setPrimaryNavigation for Fragment attached to a different FragmentManager. Fragment ");
        M.append(fragment.toString());
        M.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(M.toString());
    }
    ...
    public FragmentTransaction show(@NonNull Fragment fragment) {
        ...
        StringBuilder M = a.M("Cannot show Fragment attached to a different FragmentManager. Fragment ");
        M.append(fragment.toString());
        M.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(M.toString());
    }
