...
public final class FragmentContainerView extends FrameLayout {
    ...
    public FragmentContainerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            ...
            if (classAttribute != null && !isInEditMode()) {
                throw new UnsupportedOperationException(a.v("FragmentContainerView must be within a FragmentActivity to use ", str, "=\"", classAttribute, "\""));
            }
        }
    }
    ...
    FragmentContainerView(@NonNull Context context, @NonNull AttributeSet attributeSet, @NonNull FragmentManager fragmentManager) {
        ...
        if (classAttribute != null && findFragmentById == null) {
            if (id <= 0) {
                throw new IllegalStateException(a.t("FragmentContainerView must have an android:id to add Fragment ", classAttribute, string != null ? a.s(" with tag ", string) : ""));
            }
