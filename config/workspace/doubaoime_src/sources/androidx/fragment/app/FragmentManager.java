    ...
    */
    ...
    void attachController(@NonNull FragmentHostCallback<?> fragmentHostCallback, @NonNull FragmentContainer fragmentContainer, @Nullable final Fragment fragment) {
        ...
        if (obj instanceof ActivityResultRegistryOwner) {
            ...
            String s = a.s("FragmentManager:", fragment != null ? a.J(new StringBuilder(), fragment.mWho, Constants.COLON_SEPARATOR) : "");
            this.mStartActivityForResult = activityResultRegistry.register(a.s(s, "StartActivityForResult"), new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() { // from class: androidx.fragment.app.FragmentManager.9
            ...
            this.mStartIntentSenderForResult = activityResultRegistry.register(a.s(s, "StartIntentSenderForResult"), new FragmentIntentSenderContract(), new ActivityResultCallback<ActivityResult>() { // from class: androidx.fragment.app.FragmentManager.10
                @Override // androidx.activity.result.ActivityResultCallback
                public void onActivityResult(ActivityResult activityResult) {
                    LaunchedFragmentInfo pollFirst = FragmentManager.this.mLaunchedFragments.pollFirst();
                    if (pollFirst == null) {
            ...
            this.mRequestPermissions = activityResultRegistry.register(a.s(s, "RequestPermissions"), new ActivityResultContracts.RequestMultiplePermissions(), new ActivityResultCallback<Map<String, Boolean>>() { // from class: androidx.fragment.app.FragmentManager.11
                @Override // androidx.activity.result.ActivityResultCallback
                @SuppressLint({"SyntheticAccessor"})
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        if (arrayList2 != null && (size = arrayList2.size()) > 0) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                backStackRecord.dump(s, printWriter);
            }
        }
        printWriter.print(str);
    ...
    public Fragment getFragment(@NonNull Bundle bundle, @NonNull String str) {
        ...
        if (findActiveFragment == null) {
            throwException(new IllegalStateException(a.u("Fragment no longer exists for key ", str, ": unique id ", string)));
        }
    ...
    */
    ...
    public void putFragment(@NonNull Bundle bundle, @NonNull String str, @NonNull Fragment fragment) {
        if (fragment.mFragmentManager != this) {
            throwException(new IllegalStateException(a.p("Fragment ", fragment, " is not currently in the FragmentManager")));
        }
    ...
    void restoreSaveState(@Nullable Parcelable parcelable) {
        ...
        while (it2.hasNext()) {
            ...
            if (next != null) {
                ...
                fragment.mFragmentManager = this;
                if (isLoggingEnabled(2)) {
                    StringBuilder M = a.M("restoreSaveState: active (");
                    M.append(fragment.mWho);
                    M.append("): ");
                    M.append(fragment);
        ...
        if (fragmentManagerState.mBackStack != null) {
            ...
            while (true) {
                ...
                if (isLoggingEnabled(2)) {
                    StringBuilder N = a.N("restoreAllState: back stack #", i, " (index ");
                    N.append(instantiate.mIndex);
                    N.append("): ");
    ...
    Parcelable saveAllState() {
        ...
        if (arrayList != null && (size = arrayList.size()) > 0) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (isLoggingEnabled(2)) {
                    StringBuilder N = a.N("saveAllState: adding back stack #", i, ": ");
                    N.append(this.mBackStack.get(i));
                    Log.v(TAG, N.toString());
                }
            }
        }
    ...
    public void popBackStack(int i, int i2) {
        ...
        throw new IllegalArgumentException(a.j("Bad id: ", i));
    }
    ...
    void moveToState(int i, boolean z) {
        ...
        if (z || i != this.mCurState) {
            ...
            if (USE_STATE_MANAGER) {
                ...
                Iterator<Fragment> it2 = this.mFragmentStore.getFragments().iterator();
                while (it2.hasNext()) {
