...
class ProfileTranscoder {
    ...
    private static byte[] createCompressibleBody(@NonNull DexProfileData[] dexProfileDataArr, @NonNull byte[] bArr) throws IOException {
        ...
        StringBuilder M = e.a.a.a.a.M("The bytes saved do not match expectation. actual=");
        M.append(byteArrayOutputStream.size());
        M.append(" expected=");
        M.append(i2);
        throw Encoding.error(M.toString());
    }
    ...
    private static String generateDexKey(@NonNull String str, @NonNull String str2, @NonNull byte[] bArr) {
        ...
        return str.length() <= 0 ? enforceSeparator(str2, dexKeySeparator) : str2.equals("classes.dex") ? str : (str2.contains("!") || str2.contains(Constants.COLON_SEPARATOR)) ? enforceSeparator(str2, dexKeySeparator) : str2.endsWith(".apk") ? str2 : e.a.a.a.a.J(e.a.a.a.a.M(str), ProfileVersion.dexKeySeparator(bArr), str2);
    }
    ...
    private static int methodFlagBitmapIndex(int i, int i2, int i3) {
        ...
        throw Encoding.error(e.a.a.a.a.j("Unexpected flag: ", i));
    }
    ...
    private static DexProfileData[] readMetadataV002Body(@NonNull InputStream inputStream, @NonNull byte[] bArr, int i, DexProfileData[] dexProfileDataArr) throws IOException {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (findByDexName == null) {
                throw Encoding.error(e.a.a.a.a.s("Missing profile key: ", readString));
            }
