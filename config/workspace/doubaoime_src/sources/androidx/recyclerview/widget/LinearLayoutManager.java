...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    static class AnchorInfo {
        ...
        public String toString() {
            StringBuilder M = a.M("AnchorInfo{mPosition=");
    ...
    static class LayoutState {
        ...
        void log() {
            ...
            M.append(", offset:");
            M.append(this.mOffset);
            M.append(", layoutDir:");
            a.z0(M, this.mLayoutDirection, TAG);
        }
    ...
    private void logChildren() {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            StringBuilder M = a.M("item ");
            M.append(getPosition(childAt));
            M.append(", coord:");
            M.append(this.mOrientationHelper.getDecoratedStart(childAt));
    ...
    void validateChildOrder() {
        StringBuilder M = a.M("validating child count ");
        ...
        if (this.mShouldReverseLayout) {
            for (int i = 1; i < getChildCount(); i++) {
                ...
                if (position2 < position) {
                    logChildren();
                    StringBuilder M2 = a.M("detected invalid position. loc invalid? ");
                    M2.append(decoratedStart2 < decoratedStart);
        ...
        for (int i2 = 1; i2 < getChildCount(); i2++) {
            ...
            if (position3 < position) {
                logChildren();
                StringBuilder M3 = a.M("detected invalid position. loc invalid? ");
                M3.append(decoratedStart3 < decoratedStart);
