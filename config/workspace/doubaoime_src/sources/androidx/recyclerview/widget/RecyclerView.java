...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class LayoutManager {
        ...
        private void addViewInt(View view, int i, boolean z) {
            ...
            if (childViewHolderInt.wasReturnedFromScrap() || childViewHolderInt.isScrap()) {
                ...
                if (indexOfChild == -1) {
                    StringBuilder M = a.M("Added View has RecyclerView as parent but view is not a real child. Unfiltered index:");
                    M.append(this.mRecyclerView.indexOfChild(view));
                    M.append(this.mRecyclerView.exceptionLabel());
        ...
        */
        ...
        public void ignoreView(@NonNull View view) {
            ...
            if (parent != recyclerView || recyclerView.indexOfChild(view) == -1) {
                StringBuilder M = a.M("View should be fully attached to be ignored");
                M.append(this.mRecyclerView.exceptionLabel());
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(@NonNull View view, int i) {
            ...
            if (childViewHolderInt == null) {
                StringBuilder M = a.M("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter");
                M.append(RecyclerView.this.exceptionLabel());
                throw new IllegalArgumentException(M.toString());
            }
            ...
            if (findPositionOffset < 0 || findPositionOffset >= RecyclerView.this.mAdapter.getItemCount()) {
                StringBuilder O = a.O("Inconsistency detected. Invalid item position ", i, "(offset:", findPositionOffset, ").state:");
                O.append(RecyclerView.this.mState.getItemCount());
                O.append(RecyclerView.this.exceptionLabel());
        ...
        public int convertPreLayoutPositionToPostLayout(int i) {
            ...
            StringBuilder N = a.N("invalid position ", i, ". State item count is ");
            N.append(RecyclerView.this.mState.getItemCount());
            N.append(RecyclerView.this.exceptionLabel());
        ...
        void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                StringBuilder M = a.M("Scrapped or attached views may not be recycled. isScrap:");
                M.append(viewHolder.isScrap());
                M.append(" isAttached:");
                M.append(viewHolder.itemView.getParent() != null);
                M.append(RecyclerView.this.exceptionLabel());
                throw new IllegalArgumentException(M.toString());
            }
            ...
            if (viewHolder.shouldIgnore()) {
                StringBuilder M2 = a.M("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.");
                M2.append(RecyclerView.this.exceptionLabel());
        ...
        void scrapView(View view) {
            ...
            if (!childViewHolderInt.isInvalid() || childViewHolderInt.isRemoved() || RecyclerView.this.mAdapter.hasStableIds()) {
                ...
                StringBuilder M = a.M("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.");
                M.append(RecyclerView.this.exceptionLabel());
                throw new IllegalArgumentException(M.toString());
            }
        }
    ...
    public static abstract class SmoothScroller {
        ...
        public PointF computeScrollVectorForPosition(int i) {
            ...
            StringBuilder M = a.M("You should override computeScrollVectorForPosition when the LayoutManager does not implement ");
        ...
        void start(RecyclerView recyclerView, LayoutManager layoutManager) {
            ...
            if (this.mStarted) {
                StringBuilder M = a.M("An instance of ");
    ...
    public static class State {
        ...
        void assertLayoutStep(int i) {
            ...
            StringBuilder M = a.M("Layout state should be one of ");
        ...
        public String toString() {
            StringBuilder M = a.M("State{mTargetPosition=");
            ...
            return a.L(M, this.mRunPredictiveAnimations, '}');
        }
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            StringBuilder S = a.S(getClass().isAnonymousClass() ? "ViewHolder" : getClass().getSimpleName(), "{");
            ...
            if (!isRecyclable()) {
                StringBuilder M = a.M(" not recyclable(");
    ...
    private String getFullClassName(Context context, String str) {
        if (str.charAt(0) == '.') {
            return a.c(context, new StringBuilder(), str);
        }
        if (str.contains(".")) {
            return str;
        }
    ...
    */
    ...
    void assertInLayoutOrScroll(String str) {
        ...
        if (str == null) {
            StringBuilder M = a.M("Cannot call this method unless RecyclerView is computing a layout or scrolling");
            M.append(exceptionLabel());
            throw new IllegalStateException(M.toString());
        }
    ...
    void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            ...
            StringBuilder M = a.M("Cannot call this method while RecyclerView is computing a layout or scrolling");
            M.append(exceptionLabel());
            throw new IllegalStateException(M.toString());
        }
        if (this.mDispatchScrollCounter > 0) {
            ...
            M2.append(exceptionLabel());
            Log.w(TAG, "Cannot call this method in a scroll callback. Scroll callbacks mightbe run during a measure & layout pass where you cannot change theRecyclerView data. Any method call that might change the structureof the RecyclerView or the adapter contents should be postponed tothe next frame.", new IllegalStateException(M2.toString()));
        }
    }
    ...
    */
    ...
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
        ...
        StringBuilder M = a.M("RecyclerView has no LayoutManager");
        M.append(exceptionLabel());
        throw new IllegalStateException(M.toString());
    }
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable == null || drawable == null || stateListDrawable2 == null || drawable2 == null) {
            StringBuilder M = a.M("Trying to set fast scroller without both required drawables.");
            M.append(exceptionLabel());
            throw new IllegalArgumentException(M.toString());
        }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (findPointerIndex < 0) {
                StringBuilder M = a.M("Error processing scroll; pointer index for id ");
