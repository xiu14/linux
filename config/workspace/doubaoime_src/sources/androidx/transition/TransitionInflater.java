...
public class TransitionInflater {
    ...
    private Object createCustom(AttributeSet attributeSet, Class<?> cls, String str) {
        ...
        if (attributeValue == null) {
            throw new InflateException(a.s(str, " tag must have a 'class' attribute"));
        }
        try {
        ...
        while (true) {
            ...
            if (next == 2) {
                if (!xmlPullParser.getName().equals(TypedValues.AttributesType.S_TARGET)) {
                    StringBuilder M = a.M("Unknown scene name: ");
                            ...
                            if (namedString2 != null) {
                                ...
                                if (namedString3 != null) {
                                    try {
                                        ...
                                        throw new RuntimeException(a.s("Could not create ", namedString3), e2);
                                    }
                                } else {
