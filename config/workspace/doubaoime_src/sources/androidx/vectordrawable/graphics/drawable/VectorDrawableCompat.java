...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private void printGroupTree(VGroup vGroup, int i) {
        ...
        StringBuilder S = a.S(str, "current group is :");
        S.append(vGroup.getGroupName());
        S.append(" rotation is ");
        S.append(vGroup.mRotate);
    ...
    private static abstract class VPath extends VObject {
        ...
        public void printVPath(int i) {
            ...
            StringBuilder S = a.S(str, "current path is :");
            S.append(this.mPathName);
            S.append(" pathData is ");
            S.append(nodesToString(this.mNodes));
            Log.v(VectorDrawableCompat.LOGTAG, S.toString());
        }
