...
public abstract class VersionedParcel {
    ...
    protected Serializable readSerializable() {
        ...
        try {
            ...
            throw new RuntimeException(a.t("VersionedParcelable encountered IOException reading a Serializable object (name = ", readString, ")"), e2);
        } catch (ClassNotFoundException e3) {
            throw new RuntimeException(a.t("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = ", readString, ")"), e3);
        }
    }
    ...
    private void writeSerializable(Serializable serializable) {
        ...
        try {
            ...
            throw new RuntimeException(a.t("VersionedParcelable encountered IOException writing serializable object (name = ", name, ")"), e2);
        }
    }
