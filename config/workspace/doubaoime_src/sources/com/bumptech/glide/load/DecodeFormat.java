...
jadx.core.utils.exceptions.JadxRuntimeException: Can't remove SSA var: r0v0 com.bumptech.glide.load.DecodeFormat, still in use, count: 1, list:
  (r0v0 com.bumptech.glide.load.DecodeFormat) from 0x001a: SPUT (r0v0 com.bumptech.glide.load.DecodeFormat) (LINE:4) com.bumptech.glide.load.DecodeFormat.DEFAULT com.bumptech.glide.load.DecodeFormat
