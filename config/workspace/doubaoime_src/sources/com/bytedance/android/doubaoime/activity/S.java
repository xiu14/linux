...
public final class S extends ClickableSpan {
    ...
    final /* synthetic */ kotlin.s.c.z<String> f1938c;

    S(PrivacyStatementActivity privacyStatementActivity, kotlin.s.c.z<String> zVar, kotlin.s.c.z<String> zVar2) {
    ...
    public void onClick(@NonNull View view) {
        ...
        WebViewActivity.m(this.a, this.b.a, this.f1938c.a);
    }
