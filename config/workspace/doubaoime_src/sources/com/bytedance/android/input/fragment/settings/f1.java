...
final class f1 extends kotlin.s.c.m implements kotlin.s.b.l<View, kotlin.o> {
    final /* synthetic */ MainFragment a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    f1(MainFragment mainFragment) {
        super(1);
        this.a = mainFragment;
    }
    ...
    public kotlin.o invoke(View view) {
        ...
        if (!fragmentSettingsMainBinding.f1990e.isEnabled() && (activity = this.a.getActivity()) != null) {
            MainFragment mainFragment = this.a;
            a.C0363a c0363a = com.obric.oui.toast.a.p;
            String string = mainFragment.getString(C0838R.string.toast_tip_enable_report_inputdata);
            kotlin.s.c.l.e(string, "getString(R.string.toast…_enable_report_inputdata)");
