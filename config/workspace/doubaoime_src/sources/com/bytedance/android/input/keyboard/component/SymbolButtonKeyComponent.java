...
public final class SymbolButtonKeyComponent extends BaseTextKeyComponent {
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public SymbolButtonKeyComponent(Context context) {
        this(context, null, 0);
        l.f(context, "context");
    }
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public SymbolButtonKeyComponent(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
        l.f(context, "context");
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SymbolButtonKeyComponent(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        l.f(context, "context");
        String string = context.getString(C0838R.string.key_symbol);
        l.e(string, "context.getString(R.string.key_symbol)");
        setText(string);
        if (IAppGlobals.a.K()) {
