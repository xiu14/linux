...
public final class l implements TabLayout.OnTabSelectedListener {
    ...
    public void onTabSelected(TabLayout.Tab tab) {
        ...
        this.a.q = tab != null ? tab.getPosition() : 0;
        ...
        String str = this.a.a;
        StringBuilder M = e.a.a.a.a.M("emojiTab onTabSelected ");
        M.append(tab != null ? Integer.valueOf(tab.getPosition()) : null);
        M.append(", indexEmojiTabShow = ");
        i = this.a.q;
        M.append(i);
        M.append(", isEmojitabFirstSelection = ");
        z = this.a.o;
        M.append(z);
