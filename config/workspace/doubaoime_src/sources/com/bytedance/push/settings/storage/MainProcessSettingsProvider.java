...
public class MainProcessSettingsProvider extends ContentProvider {
    ...
    private static UriMatcher f5826c;

    /* renamed from: d, reason: collision with root package name */
    private static volatile boolean f5827d;
    ...
    public static synchronized Uri b(Context context, String str, String str2, String str3) {
        synchronized (MainProcessSettingsProvider.class) {
            ...
            if (context != null && !TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2) && !TextUtils.isEmpty(str3)) {
                return b.buildUpon().appendPath(str).appendPath(str2).appendPath("val").appendPath(str3).build();
            }
            return b;
        }
    }
    ...
    private static void c(Context context) throws IllegalStateException {
        ...
        if (TextUtils.isEmpty(a)) {
            ...
            com.bytedance.push.settings.s.a.b().a("BDPush", "getProviderAuthority: " + name);
            if (context == null) {
                c2 = null;
            } else {
                try {
                ...
                c2 = e.a.a.a.a.c(context, new StringBuilder(), ".push.settings");
            }
            a = c2;
        }
        if (TextUtils.isEmpty(a)) {
    ...
    public static boolean d(Context context) {
        return f5827d || com.bytedance.push.settings.D.a.b(context);
    }

    private static boolean e() {
        return TextUtils.isEmpty(a) || f5826c == null;
    }
    ...
    public Bundle call(String str, String str2, Bundle bundle) {
        ...
        return a2.a(getContext(), str2, bundle, PullConfiguration.PROCESS_NAME_MAIN);
    }
    ...
    public Uri insert(Uri uri, ContentValues contentValues) {
        ...
        try {
            k a2 = ((i) com.bytedance.push.settings.h.a()).a(getContext(), true, str2, PullConfiguration.PROCESS_NAME_MAIN);
            Log.d("SettingsManager", "insert on MainProcessSettingsProvider for " + str2 + " storage class name is " + a2.getClass().getName());
            edit = a2.edit();
    ...
    public Cursor query(Uri uri, String[] strArr, String str, String[] strArr2, String str2) {
        ...
        k a3;
        Object string;
        if (e() || f5826c.match(uri) != 65536 || (a2 = b.a(uri)) == null || TextUtils.isEmpty(a2.a) || TextUtils.isEmpty(a2.b) || TextUtils.isEmpty(a2.f5830d)) {
            return null;
        }
        a3 = ((i) com.bytedance.push.settings.h.a()).a(getContext(), true, a2.a, PullConfiguration.PROCESS_NAME_MAIN);
        StringBuilder M = e.a.a.a.a.M("query on MainProcessSettingsProvider for ");
        M.append(a2.a);
