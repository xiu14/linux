...
public class BottomNavigationView extends NavigationBarView {
    ...
    private int makeMinHeightSpec(int i) {
        ...
        return View.MeasureSpec.makeMeasureSpec(Math.min(View.MeasureSpec.getSize(i), getPaddingBottom() + getPaddingTop() + suggestedMinimumHeight), BasicMeasure.EXACTLY);
    }
