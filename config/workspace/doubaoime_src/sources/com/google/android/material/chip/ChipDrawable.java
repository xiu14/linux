...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    public int getIntrinsicWidth() {
        return Math.min(Math.round(this.textDrawableHelper.getTextWidth(getText().toString()) + this.chipStartPadding + calculateChipIconWidth() + this.textStartPadding + this.textEndPadding + calculateCloseIconWidth() + this.chipEndPadding), this.maxWidth);
    }
