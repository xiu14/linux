    ...
    static byte[] create(Context context, Map<Integer, Integer> map) throws IOException {
        ...
        for (Map.Entry<Integer, Integer> entry : map.entrySet()) {
            ...
            if (!context.getResources().getResourceTypeName(entry.getKey().intValue()).equals("color")) {
                StringBuilder M = a.M("Non color resource found: name=");
                M.append(colorResource2.name);
                M.append(", typeId=");
                M.append(Integer.toHexString(colorResource2.typeId & 255));
            ...
            if (colorResource2.packageId == 1) {
                ...
                if (colorResource2.packageId != Byte.MAX_VALUE) {
                    StringBuilder M2 = a.M("Not supported with unknown package id: ");
                    M2.append((int) colorResource2.packageId);
