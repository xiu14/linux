                        ...
                        if (l != null && pair.second != null) {
                            ...
                            for (int i = spanCount; i <= spanCount2; i++) {
                                ...
                                if (findViewByPosition3 != null) {
                                    ...
                                    canvas.drawRect(i == spanCount ? (findViewByPosition.getWidth() / 2) + findViewByPosition.getLeft() : 0, top, i == spanCount2 ? (findViewByPosition2.getWidth() / 2) + findViewByPosition2.getLeft() : recyclerView.getWidth(), bottom, MaterialCalendar.this.calendarStyle.rangeFill);
                                }
                            }
                        }
                    }
