...
public class TabLayout extends HorizontalScrollView {
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int i, float f2, int i2) {
            ...
            if (tabLayout != null) {
                ...
                tabLayout.setScrollPosition(i, f2, i3 != 2 || this.previousScrollState == 1, (i3 == 2 && this.previousScrollState == 0) ? false : true);
            }
        }
    ...
    */
    ...
    public void setScrollPosition(int i, float f2, boolean z, boolean z2) {
        ...
        scrollTo(i < 0 ? 0 : calculateScrollXForTab(i, f2), 0);
        if (z) {
