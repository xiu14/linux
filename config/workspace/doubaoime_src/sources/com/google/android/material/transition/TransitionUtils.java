...
class TransitionUtils {
    ...
    static View findAncestorById(View view, @IdRes int i) {
        ...
        throw new IllegalArgumentException(a.s(resourceName, " is not a valid ancestor"));
    }
    ...
    static int lerp(int i, int i2, @FloatRange(from = 0.0d, to = 1.0d) float f2, @FloatRange(from = 0.0d, to = 1.0d) float f3, @FloatRange(from = 0.0d, to = 1.0d) float f4) {
