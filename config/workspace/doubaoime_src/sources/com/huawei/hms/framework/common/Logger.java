...
public class Logger {
    ...
    private static String complexAppTag(String str) {
        return a.s(TAG_NETWORK_SDK_PRE, str);
    }
    ...
    private static String complexMsg(String str, int i) {
        ...
        return TextUtils.isEmpty(callMethodInfo) ? str : a.t(callMethodInfo, "|", str);
    }

    private static String complexTag(String str) {
        return a.s(TAG_NETWORKKIT_PRE, str);
    }
