...
public class c {
    ...
    private static final Map<String, PLSharedPreferences> f7286c = new ConcurrentHashMap(16);
    private final PLSharedPreferences a;

    public c(Context context, String str) {
        String packageName = context.getPackageName();
        Logger.d(b, "get pkgname from context is{%s}", packageName);
        Map<String, PLSharedPreferences> map = f7286c;
        if (map.containsKey(str + packageName)) {
            this.a = map.get(str + packageName);
        } else {
            PLSharedPreferences pLSharedPreferences = new PLSharedPreferences(context, e.a.a.a.a.s(str, packageName));
    ...
    private void a(Context context) {
        String str = b;
        StringBuilder M = e.a.a.a.a.M("ContextHolder.getAppContext() from GRS is:");
        M.append(ContextHolder.getAppContext());
