...
public class d {
    ...
    private void b(Map<String, String> map) {
        long time;
        if (map.containsKey(DownloadHelper.CACHE_CONTROL)) {
            String str = map.get(DownloadHelper.CACHE_CONTROL);
    ...
    */
    ...
    public boolean m() {
        return this.f7302c == 304;
    }

    public boolean n() {
        return this.f7302c == 503;
    }

    public boolean o() {
        return this.f7302c == 200;
    }
}
