...
public class CountryCodeBean {
    ...
    private void getProductCountryCode() {
        ...
        String str = TAG;
        StringBuilder M = e.a.a.a.a.M("countryCode by ro.product.locale.region is: ");
        ...
        if (TextUtils.isEmpty(this.countryCode) || GrsBaseInfo.CountryCodeSource.UNKNOWN.equals(this.countryCode)) {
            ...
            if (!TextUtils.isEmpty(property) && (lastIndexOf = property.lastIndexOf(Constants.ACCEPT_TIME_SEPARATOR_SERVER)) != -1) {
                ...
                StringBuilder M2 = e.a.a.a.a.M("countryCode by ro.product.locale is: ");
    ...
    private void getRegionSettingCountryCode() {
        ...
        String str = TAG;
        StringBuilder M = e.a.a.a.a.M("countryCode by system's region setting is: ");
        M.append(this.countryCode);
        Logger.d(str, M.toString());
    ...
    private void getVendorCountryCode() {
        ...
        this.countryCode = SystemPropUtils.getProperty(MonitorConstants.CONNECT_TYPE_GET, VENDORCOUNTRY_SYSTEMPROP, ANDRIOD_SYSTEMPROP, GrsBaseInfo.CountryCodeSource.UNKNOWN);
        String str = TAG;
        StringBuilder M = e.a.a.a.a.M("countryCode by ro.hw.country is: ");
        M.append(this.countryCode);
        Logger.d(str, M.toString());
