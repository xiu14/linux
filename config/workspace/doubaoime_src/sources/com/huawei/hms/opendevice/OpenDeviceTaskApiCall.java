...
public class OpenDeviceTaskApiCall extends TaskApiCall<OpenDeviceHmsClient, OdidResult> {
    ...
    @Override // com.huawei.hms.common.internal.TaskApiCall
    public void doExecute(OpenDeviceHmsClient openDeviceHmsClient, ResponseErrorCode responseErrorCode, String str, com.huawei.d.a.g<OdidResult> gVar) {
        ...
        if (responseErrorCode.getErrorCode() != 0) {
            StringBuilder M = e.a.a.a.a.M("onResult, returnCode: ");
            M.append(responseErrorCode.getErrorCode());
            HMSLog.i("OpenDeviceTaskApiCall", M.toString());
