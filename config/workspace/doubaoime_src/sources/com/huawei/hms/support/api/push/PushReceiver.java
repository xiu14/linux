...
public final class PushReceiver extends BroadcastReceiver {
        ...
        public void run() {
            ...
            try {
                ...
                if ("Push".equals(string) && i == 1) {
                    ...
                    bundle.putInt(WsConstants.KEY_CONNECTION_ERROR, i2);
        ...
        public void run() {
            try {
                ...
                if (byteArrayExtra != null && byteArrayExtra.length != 0) {
                    ...
                    bundle.putInt(WsConstants.KEY_CONNECTION_ERROR, this.b.getIntExtra(WsConstants.KEY_CONNECTION_ERROR, ErrorEnum.SUCCESS.getInternalCode()));
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        StringBuilder M = e.a.a.a.a.M("push receive broadcast message, Intent:");
