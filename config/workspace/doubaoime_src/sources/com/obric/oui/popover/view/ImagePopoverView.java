...
public final class ImagePopoverView extends LinkPopoverView {
    public ImagePopoverView(Context context) {
        this(context, null);
    }
    ...
    public ImagePopoverView(Context context, AttributeSet attributeSet) {
        ...
        Resources system = Resources.getSystem();
        l.e(system, "Resources.getSystem()");
        marginLayoutParams.setMarginEnd(kotlin.t.a.a(TypedValue.applyDimension(1, 8, system.getDisplayMetrics())));
