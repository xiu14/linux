...
public final class OCompoundTitleBar extends OTitleBar {
    private ImageView b;
    ...
    public OCompoundTitleBar(Context context) {
        this(context, null, 0);
    }

    @Override // com.obric.oui.titlebar.OTitleBar
    public void setDividerLineBackground(int i) {
        View view = this.f8115f;
        if (view != null) {
    ...
    public final void setTint(int i, int i2, int i3, int i4) {
        ...
        ImageView imageView3 = this.f8113d;
        if (imageView3 != null) {
            imageView3.setColorFilter(i3);
        }
        ImageView imageView4 = this.f8114e;
        if (imageView4 != null) {
            imageView4.setColorFilter(i4);
        }
    }

    public OCompoundTitleBar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OCompoundTitleBar(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        l.f(context, "context");
        FrameLayout.inflate(context, C0838R.layout.o_view_compound_title_bar, this);
        this.b = (ImageView) findViewById(C0838R.id.iv_start_0);
        this.f8112c = (ImageView) findViewById(C0838R.id.iv_start_1);
        this.f8113d = (ImageView) findViewById(C0838R.id.iv_end_0);
        this.f8114e = (ImageView) findViewById(C0838R.id.iv_end_1);
        ...
        this.f8115f = findViewById(C0838R.id.line);
        if (attributeSet != null) {
            ...
            try {
                ...
                setTitleColor(obtainStyledAttributes.getColor(1, ContextCompat.getColor(getContext(), C0838R.color.oui_basic_text_1)));
                setTitleSizePixel(obtainStyledAttributes.getDimension(2, e.i.a.b.a.c(17)));
                int color = obtainStyledAttributes.getColor(3, ContextCompat.getColor(getContext(), C0838R.color.oui_basic_text_4));
    ...
    public final void setDrawables(Drawable drawable, Drawable drawable2, Drawable drawable3, Drawable drawable4) {
        ...
        if (drawable2 == null) {
            ImageView imageView5 = this.f8112c;
            if (imageView5 != null) {
                imageView5.setVisibility(4);
            }
            ImageView imageView6 = this.f8112c;
            if (imageView6 != null) {
                imageView6.setOnClickListener(null);
            }
        } else {
            ImageView imageView7 = this.f8112c;
            if (imageView7 != null) {
                imageView7.setVisibility(0);
            }
        }
        ImageView imageView8 = this.f8112c;
        if (imageView8 != null) {
            imageView8.setImageDrawable(drawable2);
        }
        if (drawable3 == null) {
            ImageView imageView9 = this.f8113d;
            if (imageView9 != null) {
                imageView9.setVisibility(4);
            }
            ImageView imageView10 = this.f8113d;
            if (imageView10 != null) {
                imageView10.setOnClickListener(null);
            }
        } else {
            ImageView imageView11 = this.f8113d;
            if (imageView11 != null) {
                imageView11.setVisibility(0);
            }
        }
        ImageView imageView12 = this.f8113d;
        if (imageView12 != null) {
            imageView12.setImageDrawable(drawable3);
        }
        if (drawable4 == null) {
            ImageView imageView13 = this.f8114e;
            if (imageView13 != null) {
                imageView13.setVisibility(4);
            }
            ImageView imageView14 = this.f8114e;
            if (imageView14 != null) {
                imageView14.setOnClickListener(null);
            }
        } else {
            ImageView imageView15 = this.f8114e;
            if (imageView15 != null) {
                imageView15.setVisibility(0);
            }
        }
        ImageView imageView16 = this.f8114e;
        if (imageView16 != null) {
