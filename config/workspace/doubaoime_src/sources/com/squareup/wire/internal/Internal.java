...
public final class Internal {
    ...
    public static void checkElementsNotNull(List<?> list) {
        ...
        for (int i = 0; i < size; i++) {
            if (list.get(i) == null) {
                throw new NullPointerException(a.k("Element at index ", i, " is null"));
            }
        }
    }
    ...
    public static <T> List<T> copyOf(String str, List<T> list) {
        ...
        throw new NullPointerException(a.s(str, " == null"));
    }
    ...
    public static <T> List<T> immutableCopyOf(String str, List<T> list) {
        ...
        if (immutableList.contains(null)) {
            throw new IllegalArgumentException(a.s(str, ".contains(null)"));
        }
    ...
    public static void checkElementsNotNull(Map<?, ?> map) {
        ...
        for (Map.Entry<?, ?> entry : map.entrySet()) {
            ...
            if (entry.getValue() == null) {
                StringBuilder M = a.M("Value for key ");
    ...
    public static <K, V> Map<K, V> immutableCopyOf(String str, Map<K, V> map) {
        if (map != null) {
            ...
            if (!linkedHashMap.containsKey(null)) {
                ...
                throw new IllegalArgumentException(a.s(str, ".containsValue(null)"));
            }
            throw new IllegalArgumentException(a.s(str, ".containsKey(null)"));
        }
        throw new NullPointerException(a.s(str, " == null"));
    }
}
