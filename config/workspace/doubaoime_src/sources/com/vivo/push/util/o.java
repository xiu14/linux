...
public final class o extends AsyncTask<String, Void, List<Bitmap>> {
    ...
    private NotifyArriveCallbackByUser f8933f;
    ...
    public o(Context context, InsideNotificationItem insideNotificationItem, long j, boolean z, com.vivo.push.h.w wVar, NotifyArriveCallbackByUser notifyArriveCallbackByUser) {
        ...
        this.f8931d = z;
        this.f8934g = wVar;
        this.f8933f = notifyArriveCallbackByUser;
    }
    ...
    protected final /* synthetic */ void onPostExecute(List<Bitmap> list) {
        ...
        com.vivo.push.t.b(new p(this, list2));
    }
    ...
    */
    public java.util.List<android.graphics.Bitmap> doInBackground(java.lang.String... r10) {
        ...
        L1c:
            ...
            com.vivo.push.util.t.c(r2, r7)     // Catch: java.lang.Throwable -> L80 java.io.IOException -> L82 java.net.MalformedURLException -> L8e
        ...
        L83:
            ...
            com.vivo.push.util.t.a(r2, r6)     // Catch: java.lang.Throwable -> L9c
            if (r5 == 0) goto L97
        L8a:
