...
public class Config {
    ...
    public static Config defaultConfig(Context context) {
        return getBuilder().setEventEncrypted(true).setAESKey(bw.a(context)).setMaxFileLength(1048576L).setEventUploadSwitchOpen(false).setEventUploadFrequency(86400L).setPerfUploadSwitchOpen(false).setPerfUploadFrequency(86400L).build(context);
    }
    ...
    public String toString() {
        StringBuilder M = e.a.a.a.a.M("Config{mEventEncrypted=");
        M.append(this.mEventEncrypted);
        M.append(", mAESKey='");
        e.a.a.a.a.G0(M, this.mAESKey, '\'', ", mMaxFileLength=");
        M.append(this.mMaxFileLength);
        M.append(", mEventUploadSwitchOpen=");
        M.append(this.mEventUploadSwitchOpen);
        M.append(", mPerfUploadSwitchOpen=");
        M.append(this.mPerfUploadSwitchOpen);
        M.append(", mEventUploadFrequency=");
        M.append(this.mEventUploadFrequency);
        M.append(", mPerfUploadFrequency=");
        return e.a.a.a.a.E(M, this.mPerfUploadFrequency, '}');
    }
