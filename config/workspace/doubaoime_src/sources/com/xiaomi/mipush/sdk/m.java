...
public class m {
    ...
    public static void c(Context context, PackageInfo packageInfo) {
        ...
        String c2 = e.a.a.a.a.c(context, new StringBuilder(), ".permission.MIPUSH_RECEIVE");
        hashSet.addAll(Arrays.asList("android.permission.INTERNET", "android.permission.ACCESS_NETWORK_STATE", c2, "android.permission.ACCESS_WIFI_STATE", "android.permission.VIBRATE"));
        PermissionInfo[] permissionInfoArr = packageInfo.permissions;
        if (permissionInfoArr != null) {
            for (PermissionInfo permissionInfo : permissionInfoArr) {
                if (c2.equals(permissionInfo.name)) {
                    z = true;
                    break;
                }
            }
        ...
        z = false;
        if (!z) {
            throw new a(String.format("<permission android:name=\"%1$s\" .../> is undefined in AndroidManifest.", c2));
        }
    ...
    */
    public static void c(android.content.Context r8) {
        /*
            ...
            java.lang.String r4 = com.xiaomi.push.service.ay.t
            r3.<init>(r4)
            r3.setPackage(r2)
            r4 = 1
            r5 = 0
            java.lang.Class r6 = com.xiaomi.push.t.a(r8, r0)     // Catch: java.lang.ClassNotFoundException -> L55
        ...
        L55:
            r0 = move-exception
            com.xiaomi.channel.commonutils.logger.c.m18a(r0)
        L59:
        ...
        L6e:
            ...
            java.lang.Class r6 = com.xiaomi.push.t.a(r8, r6)     // Catch: java.lang.ClassNotFoundException -> L9a
