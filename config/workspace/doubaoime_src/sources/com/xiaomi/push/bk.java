...
public class bk {
    public static String a(String str) {
        try {
            ...
            com.xiaomi.channel.commonutils.logger.c.a("CloudCoder.hash4SHA1 ", e2);
            throw new IllegalStateException("failed to SHA1");
        } catch (NoSuchAlgorithmException e3) {
            com.xiaomi.channel.commonutils.logger.c.a("CloudCoder.hash4SHA1 ", e3);
            throw new IllegalStateException("failed to SHA1");
        } catch (Exception e4) {
            com.xiaomi.channel.commonutils.logger.c.a("CloudCoder.hash4SHA1 ", e4);
            throw new IllegalStateException("failed to SHA1");
        }
    }
