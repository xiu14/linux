...
public class eo {
    ...
    public void a(String str, String str2, String str3, int i, long j, String str4) {
        ...
        EventClientReport a2 = en.a(this.f381a, str2, str3, i, j, str4);
    ...
    public void a(String str, Intent intent, int i, String str2) {
        ...
        a(str, en.m352a(intent.getIntExtra("eventMessageType", -1)), intent.getStringExtra("messageId"), i, System.currentTimeMillis(), str2);
    }
    ...
    public void a(String str, Intent intent, String str2) {
        ...
        a(str, en.m352a(intent.getIntExtra("eventMessageType", -1)), intent.getStringExtra("messageId"), 5001, System.currentTimeMillis(), str2);
    }
    ...
    public void a(String str, int i, long j, long j2) {
        ...
        PerfClientReport a2 = en.a(this.f381a, i, j, j2);
        a2.setAppPackageName(str);
        a2.setSdkVersion(BuildConfig.VERSION_NAME);
        a(a2);
    }
    ...
    private void a(com.xiaomi.clientreport.data.a aVar) {
        if (aVar instanceof PerfClientReport) {
            ClientReportClient.reportPerf(this.f381a, (PerfClientReport) aVar);
        } else if (aVar instanceof EventClientReport) {
            ClientReportClient.reportEvent(this.f381a, (EventClientReport) aVar);
        }
    }
}
