...
public enum hz {
    ...
    ExposureSwitch(150),
    ExposureFilterPkgs(151),
    AIPullDownTimeRange(152),
    AIPullDownTriggerInterval(153),
    AIPullDownPopNotificationsCount(154),
    AIPullDownCacheSizeConfig(155),
    AIPullDownPopDelayTime(156),
    AIPullDownTimeStatSwitch(157),
    AIThirdAppFollowMoveIndex(158),
    AIThirdAppFollowTriggerInterval(159),
    AIThirdAppFollowMoveNotificationsCount(160),
    AIThirdAppFollowFollowList(161),
    AIThirdAppFollowFirstScreenSize(162),
    LNCSwitch(163),
    LNCBlackList(164),
    LNSSwitch(165),
    LNSFrequency(166),
    AIPushSwitch(167),
    AIPushCacheSizeConfig(168),
    AIPushTriggerInterval(169),
    AIPushTimeRange(170),
    AIPushNoPopStatSwitch(171),
    HWHeartbeatInterval(172),
    MsaAIPushCacheSizeConfig(174),
    AIPushNotifyMaxCount(175),
    AIPushTriggerDistributionRange(176),
    AIPushAOIUploadSwitch(177),
    AIPushAOIExitTimeOut(178),
    AIPushMsgTypePriority(179),
    AIPushFollowApps(180),
    AIPushBanScene(181),
    DisconnectStatMaxCount(183),
    ConnectDurationStatInterval(184),
    ConnectStatSwitch(185),
    AICacheDelayPopInterval(186),
    AICacheDelayPopNum(187),
    AITriggerPopNum(188),
    AIGlobalTriggerLimit(189),
    AISceneTriggerLimit(190),
    AIAppTriggerLimit(191),
    AIEnablePopLimitModel(192),
    AIEnableSortModel(193),
    AISceneTriggerDelayTime(194),
    AIAppEnterFrontFollowList(195),
    AIRecordAppEnterFrontWhiteList(196),
    AIModelIdConfig(197),
    AILbsMaxPopTimes(198),
    DisconnectNetworkLostDelay(199),
    AndroidWAutoGroupTemporaryFixSwitch(200),
    AIEnableIdleJudgeModel(201),
    AIStrongExposureSceneConfig(202),
    AIIdlePopTimerInterval(203),
    AIIdleSceneTriggerPopNum(204),
    AIIdlePopMsgTypeLimitNum(205),
    AIIdleMinStrongExpCount(206),
    AIIdleMinStrongExpAppWhiteConfig(207),
    AndroidWGroupStrategy(208),
    SleepMonitorSwitch(209),
    TaskHeapSizeMax(210),
    AIModelErrorLimitNotifyCodes(211),
    AIPushMsaPopNumMaxPercent(212),
    AIPushMsaScenePopLimitMap(213),
    CallKitSupportAppWhiteList(214),
    CallKitProcessRecycleSwitch(215),
    CallKitProcessRecycleTimeOut(216),
    OnePushSupportAppTraceList(217),
    ExtensionMessageMaxUploadDelayTime(218),
    BoxMsgExpiredTime(219),
    BoxMsgMaxCapacity(220),
    AIEnablePopLimitModelV2(221),
    AIPushTriggerIdCollectionList(222),
    AiPushModelSamplingRate(224),
