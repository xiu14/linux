...
public class a {
    ...
    /* renamed from: e.b.i.a.f.a$a, reason: collision with other inner class name */
    public static class C0437a<T> {
    }
    ...
    public static <T> T a(Class<?> cls, String str, Object... objArr) throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException {
        ...
        if (objArr == null || objArr.length <= 0) {
            ...
            for (int i = 0; i < objArr.length; i++) {
                Object obj = objArr[i];
                if (obj == null || !(obj instanceof C0437a)) {
        ...
        if (objArr == null || objArr.length <= 0) {
            ...
            for (int i2 = 0; i2 < objArr.length; i2++) {
                ...
                if (obj2 == null || !(obj2 instanceof C0437a)) {
                    objArr2[i2] = obj2;
                } else {
                    objArr2[i2] = null;
                }
    ...
    */
    private static java.lang.reflect.Method b(java.lang.Class<?> r11, java.lang.String r12, java.lang.Class<?>... r13) throws java.lang.NoSuchMethodException, java.lang.SecurityException {
        ...
        L33:
            ...
            if (r8 != 0) goto L60
            java.util.Map<java.lang.Class<?>, java.lang.Class<?>> r8 = e.b.i.a.f.a.a
            r9 = r6[r7]
        ...
        L82:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: e.b.i.a.f.a.b(java.lang.Class, java.lang.String, java.lang.Class[]):java.lang.reflect.Method");
    }
}
