...
internal class ModOptionsPageHandler : IDisposable
{
  ...
  private readonly ShowItemEffectRanges _showItemEffectRanges;
  ...
  public ModOptionsPageHandler(IModHelper helper, ModOptions options, bool showPersonalConfigButton)
  {
    ...
    _showItemEffectRanges = showScarecrowAndSprinklerRange;
  ...
  public void OpenOptionsMenu()
  {
    ...
    {
      gameMenu = new GameMenu(GameMenu.optionsTab);
      Game1.activeClickableMenu = gameMenu;
    }

    if (_lastMenu.Value != gameMenu || _modOptionsPage.Value is null || _modOptionsTabPageNumber.Value is null)
    {
      EarlyOnMenuChanged(_lastMenu.Value, gameMenu);
      _lastMenu.Value = gameMenu;
    }
  ...
  {
    _showItemEffectRanges.ToggleMobileRange();
  }

  public bool IsMobileRangeEnabled()
  {
    return _showItemEffectRanges.IsMobileRangeEnabled;
  }
