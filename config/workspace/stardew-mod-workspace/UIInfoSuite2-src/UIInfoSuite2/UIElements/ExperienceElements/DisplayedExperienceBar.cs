...
public class DisplayedExperienceBar
{
  ...
  )
  {
    ...
    ClickableTextureComponent experienceBar = GetExperienceBarTextureComponent(leftSide);
    string experienceText = experienceEarnedThisLevel + "/" + experienceDifferenceBetweenLevels;
    MobileTapTooltip.Register(experienceBar.bounds, experienceText);

    if (IsMouseOverExperienceBar(leftSide) || MobileTapTooltip.IsActive(experienceBar.bounds, experienceText))
    {
