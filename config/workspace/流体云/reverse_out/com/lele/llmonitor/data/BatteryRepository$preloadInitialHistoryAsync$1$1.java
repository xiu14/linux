...
final class BatteryRepository$preloadInitialHistoryAsync$1$1 extends jj3 implements h11 {
    int label;

    public BatteryRepository$preloadInitialHistoryAsync$1$1(n60 p2)
    {
        super(2, p2);
        return;
    }
    ...
    {
        this = new com.lele.llmonitor.data.BatteryRepository$preloadInitialHistoryAsync$1$1;
        this(p2);
        return this;
    }
    ...
    {
        return ((com.lele.llmonitor.data.BatteryRepository$preloadInitialHistoryAsync$1$1) this.create(p1, p2)).invokeSuspend(bw3.a);
    }
